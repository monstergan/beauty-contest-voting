package com.voter.enums;

import com.voter.dto.ResultCode;
...
public enum RespCode implements ResultCode {
     ...
     * CONNECT_EXCEPTION
     */
    CONNECT_EXCEPTION("530", "Service Connect Exception", "服务器内部连接异常"),
    /**
     ...
     * MULTIPART_EXCEPTION
     */
    MULTIPART_EXCEPTION("600", "Multipart Resolution Fails", "文件上传解析异常"),
    /**
     * MAX_UPLOAD_SIZE_EXCEEDED
     */
    MAX_UPLOAD_SIZE_EXCEEDED("601", "Max Upload Size Exceeded", "超过文件服务器最大上传大小");
